...
export class ErrorBoundary extends Component {
  ...
  render() {
    ...
    return (
      <div style={{ position:"fixed", inset:0, background:"var(--bg)", display:"flex", alignItems:"center", justifyContent:"center", fontFamily:"system-ui", zIndex:999 }}>
        <div style={{ background:"var(--bg2)", border:"1px solid rgba(239,68,68,0.3)", borderRadius:16, padding:32, width:440, maxWidth:"90vw", textAlign:"center" }}>
          <div style={{ fontSize:40, marginBottom:16 }}>🤷‍♂️</div>
          <h2 style={{ color:"#f87171", fontSize:18, margin:"0 0 10px" }}>Jotain meni pieleen</h2>
          <p style={{ color:"var(--text2)", fontSize:13, lineHeight:1.6, margin:"0 0 20px" }}>
            Sovelluksessa tapahtui odottamaton virhe. Virhe on kirjattu ylläpidolle automaattisesti.
          </p>
          <div style={{ background:"var(--bg3)", borderRadius:8, padding:"10px 14px", marginBottom:20, fontSize:11, color:"var(--text3)", textAlign:"left", wordBreak:"break-all" }}>
          ...
          <div style={{ display:"flex", gap:10, justifyContent:"center" }}>
            ...
            <button onClick={() => { window.location.href = "/" }}
              style={{ background:"transparent", border:"1px solid var(--border2)", borderRadius:8, color:"var(--text2)", padding:"9px 20px", cursor:"pointer", fontSize:13, fontFamily:"system-ui" }}>
              Etusivulle
            </button>
          </div>
        </div>
